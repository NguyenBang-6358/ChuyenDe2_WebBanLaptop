...
function RegisterPage() {
  ...
  // Đăng ký & Đăng nhập Google chuẩn Google Identity Services (accounts.google.com)
    ...
    <div className="max-w-md mx-auto px-4 py-16">
      <div className="bg-white dark:bg-slate-800 p-8 rounded-3xl border border-slate-100 dark:border-slate-800 shadow-xl space-y-6">
        ...
        <div className="text-center space-y-2">
          <h2 className="text-2xl font-bold text-slate-900 dark:text-slate-100">Tạo Tài Khoản</h2>
          <p className="text-xs text-slate-500 dark:text-slate-400">
            Trở thành thành viên để nhận ưu đãi và mua sắm dễ dàng hơn
          </p>
        </div>
